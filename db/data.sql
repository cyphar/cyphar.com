...
INSERT INTO tbl_kudos (priority, ack, vuln, url, description) VALUES (20, "Microsoft (Online Services)", "Coldfusion Exploit (Root Access)", "http://technet.microsoft.com/en-us/security/cc308589", "Due to an outdated version of Coldfusion installed on a Microsoft MSN, I was able to bypass the administrative logon and gain administrative access. This would allow me to schedule tasks to run as a privelliged user, such as reverse shells, create users, etc.");
